                    ...
                    Column(children: <Widget>[
                      GestureDetector(
                            onTap: () {
                              ...
                              for (int j = 0;
                                  j < listProvider.indivWorkouts[index].repsCompleted.length;
                                  j++) {
                                copyRepsCompleted.add([0]);
                                copyRepsCompleted[j]
                                    .add(listProvider.indivWorkouts[index].repsCompleted[j][0]);
                                copyRepsCompleted[j].removeAt(0);
                                for (int k = 1;
                                    k < listProvider.indivWorkouts[index].repsCompleted[j].length;
                                    k++) {
                                  copyRepsCompleted[j]
                                      .add(listProvider.indivWorkouts[index].repsCompleted[j][k]);
                                }
                              }
                              globals.postWorkoutTempNote = listProvider.indivWorkouts[index].note;
                            ...
                            child: Container(
                                ...
                                child: Column(children: [
                                  Row(children: <Widget>[
                                    Expanded(
                                      child: Align(
                                        ...
                                        child: Text(listProvider.indivWorkouts[index].name,
                                            style: TextStyle(
                                              fontSize: 16,
                                    ...
                                    Expanded(
                                      child: Align(
                                        ...
                                        child: Text(listProvider.indivWorkouts[index].date,
                                            style: TextStyle(
                                              fontSize: 16,
                                              color: globals.greyColor,
                                            )),
                                  ...
                                  Column(children: [
                                    for (int j = 0;
                                        j < listProvider.indivWorkouts[index].exercisesCompleted.length;
                                        j++)
                                      Column(children: <Widget>[
                                        Row(
                                            mainAxisAlignment:
                                            ...
                                            children: <Widget>[
                                              Expanded(
                                                child: Align(
                                                  ...
                                                  child: Text(
                                                      listProvider.indivWorkouts[index].exercisesCompleted[
                                                          j],
                                                      style: TextStyle(
                                                        fontSize: 16,
                                                        color:
    ...
    for (int k = 0; k < listProvider.indivWorkouts[i].setsPlanned[j]; k++) {
      ...
      if (k != listProvider.indivWorkouts[i].setsPlanned[j] - 1) {
        ...
        listProvider.indivWorkouts[i].weights[j] % 1 == 0
            ? output += listProvider.indivWorkouts[i].weights[j].toInt().toString()
