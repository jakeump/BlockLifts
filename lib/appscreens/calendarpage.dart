              ...
              body: Column(children: <Widget>[
                ...
                Row(children: <Widget>[
                  SizedBox(
                      ...
                      child: Center(
                          child:
                              Text("S", style: TextStyle(color: globals.textColor)))),
                  SizedBox(
                      width: MediaQuery.of(context).size.width * (1 / 7),
                      child: Center(
                          child:
                              Text("M", style: TextStyle(color: globals.textColor)))),
                  SizedBox(
                      width: MediaQuery.of(context).size.width * (1 / 7),
                      child: Center(
                          child:
                              Text("T", style: TextStyle(color: globals.textColor)))),
                  SizedBox(
                      width: MediaQuery.of(context).size.width * (1 / 7),
                      child: Center(
                          child:
                              Text("W", style: TextStyle(color: globals.textColor)))),
                  SizedBox(
                      width: MediaQuery.of(context).size.width * (1 / 7),
                      child: Center(
                          child:
                  ...
                  SizedBox(
                      ...
                      child: Center(
                          child:
                              Text("F", style: TextStyle(color: globals.textColor)))),
                  SizedBox(
                      width: MediaQuery.of(context).size.width * (1 / 7),
                      child: Center(
                          child:
                        ...
                        monthBuilder: (context, month, year) {
                          return Container(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(fontSize: 14, color: globals.textColor),
                            ),
                          );
                        })),
              ]));
