  ...
  Widget build(BuildContext context) {
    AwesomeNotifications().actionStream.listen((action) {
      if (action.buttonKeyPressed == "done") {
        incrementCircles(globals.workoutIndex, globals.exerciseIndex, globals.setIndex + 1, false);
      } else if (action.buttonKeyPressed == "failed") {
        incrementCircles(globals.workoutIndex, globals.exerciseIndex, globals.setIndex + 1, true);
      }
    });
